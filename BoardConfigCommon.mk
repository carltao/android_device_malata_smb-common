...
BOARD_DATA_DEVICE := /dev/block/mmcblk3p6
BOARD_DATA_FILESYSTEM := ext3
BOARD_CACHE_DEVICE := /dev/block/mmcblk3p2
BOARD_CACHE_FILESYSTEM := ext3
BOARD_SDCARD_DEVICE_PRIMARY := /dev/block/mmcblk3p8
BOARD_SDCARD_DEVICE_SECONDARY := /dev/block/mmcblk2p1
BOARD_SDCARD_DEVICE_INTERNAL := /dev/block/mmcblk3p8
